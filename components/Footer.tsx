...
const Footer = () => {
  return (
    <div className="flex flex-row items-center justify-between p-4 w-full z-50 mt-8 bg-background">
        <h1 className='cursor-default'><span className='text-lg font-extrabold'>ODAY-DEV</span><span className='text-sm'>.app</span></h1>
        <ul className={`hidden4phone flex items-center justify-center gap-4 `}>
